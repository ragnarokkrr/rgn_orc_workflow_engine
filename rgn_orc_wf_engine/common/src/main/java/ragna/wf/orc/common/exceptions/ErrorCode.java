...
public enum ErrorCode {
  ...
  CANT_FINISH_TASK_INVALID_STATE(
          "ORC-0003", "Can finish task only if Orchestrating workflow"),
  CANT_FINISH_TASK_INVALID_TASK_STATE(
          "ORC-0004", "Can finish task only if Task Status is TRIGGERED"),
  TASK_NOT_FOUND(
          "ORC-0005", "Task not found"),
  INVALID_STATE_TO_RIGGER_TASK("ORC-0006", "Task should be PLANNED to trigger"),
  TRIED_TO_TRIGGER_FIRST_TASK_IN_WRONG_PLACE("ORC-0007", "Tried to trigger first task in wrong place");
  String code;
  String message;
