...
public class PlannedTask {
    ...
    private int order;
    @Builder.Default
    private Result result = Result.WAITING_FOR_RESULT;
    @Builder.Default
    ...
    public PlannedTask addTaskCriteriaEvaluation(final List<TaskCriteriaResult> taskCriteriaResult) {
        this.taskCriteriaResult = taskCriteriaResult
                .stream()
                .collect(Collectors.toMap(PlannedTask.TaskCriteriaResult::getId, taskCriteriaResult1 -> taskCriteriaResult1));
